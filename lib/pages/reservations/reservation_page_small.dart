...
class ReservationPageSmall extends StatelessWidget {
  ReservationPageSmall({Key? key}) : super(key: key);
                    ...
                    child: Container(
                      child: Center(
                        child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                          stream: ffstore.collection("MyPickup").snapshots(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          buildRow(
              title: 'Distance', subtitle: "${((requestModel?.distanceInKm ?? 0) * 0.62137).toStringAsFixed(2)} miles"),
          SizedBox(height: 20),
